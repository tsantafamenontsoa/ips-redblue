#!/bin/bash
# =============================================================================
#  payloads.sh — Equipe 5 — Round 1 (Injection SQL)
#
#  Usage (apres avoir deploye les regles adverses) :
#    bash attacks/equipe-5/payloads.sh <ip_dvwa>
#
...
TARGET="${1:-dvwa}"
PORT="80"
COOKIE_FILE="/tmp/dvwa_eq5.txt"

echo "=== Equipe 5 — Attaques R1 (Injection SQL) ==="
