#!/bin/bash
# =============================================================================
#  payloads.sh — Equipe 7 — Round 1 (Injection SQL)
#
#  Usage (apres avoir deploye les regles adverses) :
#    bash attacks/equipe-7/payloads.sh <ip_dvwa>
#
...
TARGET="${1:-dvwa}"
PORT="80"
COOKIE_FILE="/tmp/dvwa_eq7.txt"

echo "=== Equipe 7 — Attaques R1 (Injection SQL) ==="
