#!/bin/bash
# =============================================================================
#  payloads.sh — Equipe 3 — Round 1 (Injection SQL)
#
#  Usage (apres avoir deploye les regles adverses) :
#    bash attacks/equipe-3/payloads.sh <ip_dvwa>
#
...
TARGET="${1:-dvwa}"
PORT="80"
COOKIE_FILE="/tmp/dvwa_eq3.txt"

echo "=== Equipe 3 — Attaques R1 (Injection SQL) ==="
